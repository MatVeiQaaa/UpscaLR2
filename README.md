...
1. Download `fmodex.dll` and `UpscaLR2.dll` from one of [releases](https://github.com/MatVeiQaaa/UpscaLR2/releases). If you don't know which one you want, grab [latest](https://github.com/MatVeiQaaa/UpscaLR2/releases/latest).
2. Rename `fmodex.dll` in the root of your Lunatic Rave 2 folder into `fmodex_real.dll`. 
3. If you previously used [chainloader](https://github.com/SayakaIsBaka/lr2_chainload) to load your mods, remove `d3d9.dll` from the game folder.
